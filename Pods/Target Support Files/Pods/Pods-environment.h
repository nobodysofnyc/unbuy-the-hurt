...
// ScanditSDK
#define COCOAPODS_POD_AVAILABLE_ScanditSDK
#define COCOAPODS_VERSION_MAJOR_ScanditSDK 4
#define COCOAPODS_VERSION_MINOR_ScanditSDK 1
#define COCOAPODS_VERSION_PATCH_ScanditSDK 2
